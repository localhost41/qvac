...
test('groot integration: VlaModel.run() produces finite, correctly-shaped actions', { timeout: 2400000 }, async (t) => {
  let inputs
  if (_isMobile) {
  ...
  for (const backend of backends) {
    ...
    try {
      ...
      _perfReporter.record(`end-to-end inference (groot/${backend})`, {
